					...
					<div class="row">
						...
						<div class="main col-md-6" style="min-height:650px">
							...
							<dl class="dl-horizontal">
								...
								<dd>
									<span id="uname">${sessionScope.name}</span>
								</dd>
								<hr>
								<dt>									
								...
								<dd>
									...
									<c:if test="${(sessionScope.userStatus!=null)&&(sessionScope.userStatus==('NO'))}">
										&nbsp&nbsp<a href="${pageContext.request.contextPath}/action/emailVerify.jsp">前去验证</a>
									</c:if>
								</dd>
								<hr>
								...
								<dd>
									<span id="uwechat">${sessionScope.userWechat}</span>
								</dd>
								<hr>
								<dt>									
								...
								<dd>
									<span id="ugender">${sessionScope.userSex}</span>
								</dd>
								<hr>
								<dt>									
								...
								<dd>
									<span id="ugender">${sessionScope.userPhone}</span>
								</dd>
								<hr>
							...
							&nbsp&nbsp<small><a href="user_info_change.jsp" style="color:blue">修改</a></small>
						</div>
						<!-- main end -->
