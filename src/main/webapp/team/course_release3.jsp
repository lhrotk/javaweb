		...
		<div class="container user-home">
			<div class="row">
				...
				<div class="main col-md-9">
					...
					<h2>发布一门课程(3/3)</h2>
					<hr>
						<h4>完善课程内容&nbsp<span style="color:red">(请不要后退更改信息)</span></h4>
						<small>您的课程已创建完成，以下内容您也可以稍后再已发布的课程中进行更改</small>
						<hr>
							<!-- general info start-->
							...
							<div class="basic-info">
								...
								<dl id="info-table" class="dl-horizontal">
									<dt>课程标题：</dt>
									<dd id="title">${sessionScope.newClass.title}</dd>

									<dt>课程代号：</dt>
									<dd id="course-id">${sessionScope.newClass.code}</dd>

									<dt>发布者：</dt>
									<dd id="publisher">
										<a herf="team_example.html">${sessionScope.launcher.nickname}</a>
									</dd>

									<dt>讲师：</dt>
									<dd id="instructor">${sessionScope.tutor.nickname}</dd>

									<dt>联系方式：</dt>
									<dd id="instructor-contact">
										<i class="fa fa-wechat pr-10"></i>${sessionScope.tutor.wechat} <br> <i
											class="fa fa-envelope-o pr-10"></i>${sessionScope.tutor.email} <br> <i
												class="fa fa-phone pr-10"></i>${sessionScope.tutor.phone} <br>
									</dd>

									<dt>价格：</dt>
									<!-- 如果有旧的价格则显示 -->
									<dd id="price">${sessionScope.newClass.o_price}</dd>

									<dt>类型：</dt>
									<dd>
									<c:if test="${sessionScope.newClass.type==1}">
										<input type="radio" name="type-once" id="type-once"
											value="type-once" checked disabled/> 单次 <input
											type="radio" name="type-pack" id="type-pack"
									...
									<input type="hidden" name="class_id" value="${sessionScope.newClass.class_id}"/>
									<dt>课程简介:</dt>
							...
							<script type="text/javascript">
							$(function(){
								var class_id = ${sessionScope.newClass.class_id};
							...
							<div class="steps">
								  	...
								  	<s:iterator value="#session.lessonIdList" id="lessonId" status="lessonSeq" >
								  	<hr>
								  	<input type="hidden" name="lessonList[${lessonSeq.index}].lesson_id" value="${lessonId}">
									<h4 class="title">第${lessonSeq.index+1}次课程</h4>

									<div class="form-group has-feedback">
										<label for="course_date" class="control-label col-sm-2">开课日期</label>
										<div class="col-md-4">
											<input type="date" class="form-control" id="course_date_1" name="lessonList[${lessonSeq.index}].inputDate" disabled>
											<i class="fa form-control-feedback"></i>
										</div>
									...
									<div class="form-group has-feedback">
										...
										<div class="col-md-4">
											<input type="time" name="lessonList[${lessonSeq.index}].inputTime" class="form-control" id="course_time_1" disabled>
											<i class="fa form-control-feedback"></i>
										</div>
									...
									<div class="form-group has-feedback">
										...
										<div class="col-md-4">
											<input type="number" name="lessonList[${lessonSeq.index}].duration" class="form-control" id="course_length_1" min="30" max="600" step="15" placeholder="最短30分钟，最长600分钟" disabled>
											<i class="fa form-control-feedback"></i>
										</div>
									...
									<div class="form-group has-feedback">
										...
										<div class="col-md-4">
											<input type="text" name="lessonList[${lessonSeq.index}].place" class="form-control" id="course_loc_1" maxlength="30" disabled>
											<i class="fa form-control-feedback"></i>
										</div>
									...
									<div class="form-group has-feedback">
										...
										<div class="col-md-6">
											<textarea  class="form-control" name="lessonList[${lessonSeq.index}].description" id="course_des_1" row="15"  placeholder="简单介绍您的课程" maxlength="1000"></textarea>
											<i class="fa form-control-feedback"></i>
										</div>
									</div>
									 ...
									 <div class="form-group">
										...
										<label for="files" class="control-label col-sm-2">附件</label>
											...
											<s:url id="searchUrl" escapeAmp="false" value="/course/editfilesearch">
												<s:param name="lesson_id" value="#lessonId"/>
												<s:param name="class_id" value="#session.newClass.class_id"/>
											</s:url>
											<sx:div href="%{searchUrl}" id="div_%{#lessonId}" executeScripts="true"></sx:div>
											
											<sx:bind executeScripts="true" targets="div_%{#lessonId}" href="%{#searchUrl}" listenTopics="/request"/>
								  		</dl>
